            ...
            @forelse ($this->apiKeys as $key)
                <div class="flex items-center justify-between rounded-lg border border-zinc-200 bg-white p-4 dark:border-zinc-700 dark:bg-zinc-900">
                    <div class="flex items-center gap-4">
                        <div class="flex size-10 items-center justify-center rounded-full {{ $key['is_active'] ? 'bg-green-100 dark:bg-green-900/30' : 'bg-red-100 dark:bg-red-900/30' }}">
                            <flux:icon name="key" class="size-5 {{ $key['is_active'] ? 'text-green-600 dark:text-green-400' : 'text-red-600 dark:text-red-400' }}" />
                        </div>
                        <div>
