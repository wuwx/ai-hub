                ...
                <div class="animate-slide-in">
                    <div class="code-window rounded-2xl shadow-2xl shadow-black/50 overflow-hidden">
                        ...
                        <div class="p-5 font-mono text-sm leading-7 overflow-x-auto">
                            ...
                            <div class="text-zinc-500"># with failover, rate limiting & token quotas</div>
                            <div class="mt-2">
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="glass rounded-2xl p-6 glass-hover transition-all duration-300 group">
                    ...
                    <h3 class="text-lg font-semibold mb-2 group-hover:text-emerald-300 transition-colors">Circuit Breaker Protection</h3>
                    <p class="text-zinc-400 text-sm leading-relaxed">Automatic circuit breakers trip unhealthy providers in milliseconds, so a single failing upstream never cascades into downtime for your requests.</p>
                </div>
                ...
                <div class="glass rounded-2xl p-6 glass-hover transition-all duration-300 group">
                    ...
                    <h3 class="text-lg font-semibold mb-2 group-hover:text-rose-300 transition-colors">Content Safety</h3>
                    <p class="text-zinc-400 text-sm leading-relaxed">Built-in content filtering screens prompts and responses for unsafe content before they reach providers, keeping you compliant by default.</p>
                </div>
                ...
                @foreach($plans as $plan)
                    ...
                    <div class="rounded-2xl p-8 {{ $isPopular ? 'pricing-popular relative' : 'glass' }} transition-all duration-300 hover:-translate-y-1">
                        ...
                        <div class="mb-8">
                            ...
                            @elseif($code === 'enterprise')
                                <span class="text-4xl font-bold">Custom</span>
                            @else
                                <span class="text-4xl font-bold">{{ $plan->name }}</span>
                            @endif
                        </div>
