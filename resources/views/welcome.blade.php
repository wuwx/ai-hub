        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="glass rounded-2xl p-6 glass-hover transition-all duration-300 group">
                    ...
                    <p class="text-zinc-400 text-sm leading-relaxed">Track tokens, costs, latency, and error rates per model, team, and API key. Beautiful dashboards included.</p>
                </div>
                ...
                <div class="glass rounded-2xl p-6 glass-hover transition-all duration-300 group">
                    ...
                    <h3 class="text-lg font-semibold mb-2 group-hover:text-rose-300 transition-colors">Team Collaboration</h3>
                    <p class="text-zinc-400 text-sm leading-relaxed">Invite team members, assign roles, and manage access. Shared wallet billing with per-member usage quotas.</p>
                </div>
                ...
                <div class="glass rounded-2xl p-6 glass-hover transition-all duration-300 group">
                    ...
                    <p class="text-zinc-400 text-sm leading-relaxed">Set token quotas per team and key. Get alerts before you overspend. Prepaid wallet system for predictable billing.</p>
                </div>
            </div>
        </div>
    </section>
        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid md:grid-cols-3 gap-8">
                ...
                <div class="relative text-center">
                    ...
                    <p class="text-zinc-400 text-sm leading-relaxed">Sign up for free. Create a team and generate your first API key in seconds.</p>
    ...
    <section class="relative py-24 lg:py-32 border-t border-white/5 overflow-hidden">
        ...
        <div class="relative max-w-4xl mx-auto px-4 sm:px-6 lg:px-8 text-center">
            ...
            <p class="mt-6 text-lg text-zinc-400 max-w-2xl mx-auto">
                Join developers and teams who use AI Hub to simplify their LLM operations. Get started in minutes with our free tier.
            </p>
