        ...
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            <div class="grid sm:grid-cols-2 lg:grid-cols-3 gap-6">
                ...
                <div class="glass rounded-2xl p-6 glass-hover transition-all duration-300 group">
                    ...
                    <p class="text-zinc-400 text-sm leading-relaxed">Invite team members, assign roles, and manage access. Shared team subscription with per-member usage quotas.</p>
                </div>
                ...
                <div class="glass rounded-2xl p-6 glass-hover transition-all duration-300 group">
                    ...
                    <p class="text-zinc-400 text-sm leading-relaxed">Set token quotas per team and key. Get alerts before you overspend. Predictable monthly subscription billing.</p>
                </div>
            </div>
        </div>
    </section>
