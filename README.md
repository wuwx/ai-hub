...
- `app/Models`: ApiKey、AuditLog、BillingInvoice(Item)、LlmModel/Provider、McpServer、Team（含 Wallet/Subscription/QuotaPolicy/Entitlements）、User 等
- `database/migrations`: 网关、用量、配额、账单、钱包、审计日志、Passkeys 等表结构
