...
- `app/Models`: ApiKey、BillingInvoice(Item)、LlmModel/Provider、McpServer、Team（含 Wallet/Subscription/QuotaPolicy/Entitlements）、User 等（活动日志直接使用 spatie/laravel-activitylog 内置 `Activity` 模型）
