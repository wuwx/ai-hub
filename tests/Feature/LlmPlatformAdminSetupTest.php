...
it('creates llm platform tables with key columns', function () {
    ...
    expect(Schema::hasTable('team_billing_subscriptions'))->toBeTrue();
    ...
    expect(Schema::hasColumns('team_billing_subscriptions', ['team_id', 'plan_code', 'status', 'stripe_subscription_id']))->toBeTrue();
});
